...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002166942700').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1114789110 7170452349').split()]
auth_channel = environ.get('AUTH_CHANNEL', '')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002235094272')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002192220089')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", True))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://naturecreation277:UXhOlYWOIOqINmSp@cluster0.wjssof4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'c3ab7f68857a356db3bbddc7995fd0bd23aedeb2')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+swpuQspBoVxiNjdl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Ra_yan_2024_movie')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howto_open_short_link/10')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002239721483'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'af_support_chat')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002209778862'))
